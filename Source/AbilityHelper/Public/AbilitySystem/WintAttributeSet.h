...
#include "WintAttributeSet.generated.h"
 ...
 */
UCLASS()
class ABILITYHELPER_API UWintAttributeSet : public UAttributeSet
{
	GENERATED_BODY()
...
public:
	...
	ATTRIBUTE_ACCESSORS(UWintAttributeSet, Health);

	UPROPERTY(BlueprintReadOnly, ReplicatedUsing = OnRep_MaxHealth, Category = "Vital Attributes")
	FGameplayAttributeData MaxHealth;
	ATTRIBUTE_ACCESSORS(UWintAttributeSet, MaxHealth);
